...
//
// The check is a comparison of the on-chain flag against the
// --espresso.enabled flag.
...
// hasBatchAuthenticator returns true if a BatchAuthenticator reader was bound
// at construction.
func (l *BatchSubmitter) hasBatchAuthenticator() bool {
	return l.batchAuth != nil
}
