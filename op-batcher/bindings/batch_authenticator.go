...
func (_BatchAuthenticator *BatchAuthenticatorTransactor) AuthenticateBatchInformation(opts *bind.TransactOpts, commitment [32]byte, _signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.contract.Transact(opts, "authenticateBatchInformation", commitment, _signature)
}

// AuthenticateBatchInformation is a paid mutator transaction binding the contract method 0x59cd3233.
//
// Solidity: function authenticateBatchInformation(bytes32 commitment, bytes _signature) returns()
func (_BatchAuthenticator *BatchAuthenticatorSession) AuthenticateBatchInformation(commitment [32]byte, _signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.AuthenticateBatchInformation(&_BatchAuthenticator.TransactOpts, commitment, _signature)
}

// AuthenticateBatchInformation is a paid mutator transaction binding the contract method 0x59cd3233.
//
// Solidity: function authenticateBatchInformation(bytes32 commitment, bytes _signature) returns()
func (_BatchAuthenticator *BatchAuthenticatorTransactorSession) AuthenticateBatchInformation(commitment [32]byte, _signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.AuthenticateBatchInformation(&_BatchAuthenticator.TransactOpts, commitment, _signature)
}
