...
func (_BatchAuthenticator *BatchAuthenticatorCaller) ValidBatches(opts *bind.CallOpts, arg0 [32]byte) (bool, error) {
	var out []interface{}
	err := _BatchAuthenticator.contract.Call(opts, &out, "validBatches", arg0)
...
//
// Solidity: function validBatches(bytes32 ) view returns(bool)
func (_BatchAuthenticator *BatchAuthenticatorSession) ValidBatches(arg0 [32]byte) (bool, error) {
	return _BatchAuthenticator.Contract.ValidBatches(&_BatchAuthenticator.CallOpts, arg0)
}

// ValidBatches is a free data retrieval call binding the contract method 0x177db6ae.
//
// Solidity: function validBatches(bytes32 ) view returns(bool)
func (_BatchAuthenticator *BatchAuthenticatorCallerSession) ValidBatches(arg0 [32]byte) (bool, error) {
	return _BatchAuthenticator.Contract.ValidBatches(&_BatchAuthenticator.CallOpts, arg0)
}
...
//
// Solidity: function __constructor__(address _espressoTEEVerifier, address _preApprovedBatcher) returns()
func (_BatchAuthenticator *BatchAuthenticatorTransactor) Constructor(opts *bind.TransactOpts, _espressoTEEVerifier common.Address, _preApprovedBatcher common.Address) (*types.Transaction, error) {
	return _BatchAuthenticator.contract.Transact(opts, "__constructor__", _espressoTEEVerifier, _preApprovedBatcher)
}

// Constructor is a paid mutator transaction binding the contract method 0x63f9288d.
//
// Solidity: function __constructor__(address _espressoTEEVerifier, address _preApprovedBatcher) returns()
func (_BatchAuthenticator *BatchAuthenticatorSession) Constructor(_espressoTEEVerifier common.Address, _preApprovedBatcher common.Address) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.Constructor(&_BatchAuthenticator.TransactOpts, _espressoTEEVerifier, _preApprovedBatcher)
}

// Constructor is a paid mutator transaction binding the contract method 0x63f9288d.
//
// Solidity: function __constructor__(address _espressoTEEVerifier, address _preApprovedBatcher) returns()
func (_BatchAuthenticator *BatchAuthenticatorTransactorSession) Constructor(_espressoTEEVerifier common.Address, _preApprovedBatcher common.Address) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.Constructor(&_BatchAuthenticator.TransactOpts, _espressoTEEVerifier, _preApprovedBatcher)
}

// AuthenticateBatch is a paid mutator transaction binding the contract method 0x1eea09c7.
//
// Solidity: function authenticateBatch(bytes32 commitment, bytes signature) returns()
func (_BatchAuthenticator *BatchAuthenticatorTransactor) AuthenticateBatch(opts *bind.TransactOpts, commitment [32]byte, signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.contract.Transact(opts, "authenticateBatch", commitment, signature)
}

// AuthenticateBatch is a paid mutator transaction binding the contract method 0x1eea09c7.
//
// Solidity: function authenticateBatch(bytes32 commitment, bytes signature) returns()
func (_BatchAuthenticator *BatchAuthenticatorSession) AuthenticateBatch(commitment [32]byte, signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.AuthenticateBatch(&_BatchAuthenticator.TransactOpts, commitment, signature)
}

// AuthenticateBatch is a paid mutator transaction binding the contract method 0x1eea09c7.
//
// Solidity: function authenticateBatch(bytes32 commitment, bytes signature) returns()
func (_BatchAuthenticator *BatchAuthenticatorTransactorSession) AuthenticateBatch(commitment [32]byte, signature []byte) (*types.Transaction, error) {
	return _BatchAuthenticator.Contract.AuthenticateBatch(&_BatchAuthenticator.TransactOpts, commitment, signature)
}
