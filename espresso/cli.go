...
const (
	...
	// DefaultBatchAuthLookbackWindow is declared in constants.go (which has no
	// build tag) so that mips64-reachable code can reference it. The doc
	// comment lives there as well.
