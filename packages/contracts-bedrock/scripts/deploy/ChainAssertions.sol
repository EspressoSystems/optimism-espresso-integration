...
library ChainAssertions {
        ...
        view
    {
        ...
        require(keccak256(proxyPreamble.initcode) == keccak256(vm.getCode("src/universal/Proxy.sol:Proxy")), "CHECK-OPCM-170"); // Espresso: disambiguate from OZ v5 proxy/Proxy.sol artifact
